...
png(filename = "plot2.png",width = 480, height = 480) #open png file to save graph
plot(dateTime,Global_active_power,type = "l",xlab = "",ylab="Global Active Power (kilowatts)") #create graph
