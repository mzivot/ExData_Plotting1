...
png(filename = "plot4.png",width = 480, height = 480) #open png file to save graph
par(mfrow = c(2,2),mar = c(4,4,2,2))
plot(dateTime,Global_active_power,type = "l",xlab = "",ylab="Global Active Power") #create graph
plot(dateTime,Voltage,type = "l",xlab = "datetime") #create graph
...
plot(dateTime,Global_reactive_power,type = "l",xlab = "datetime") #create graph
